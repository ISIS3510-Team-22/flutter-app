...
Widget build(BuildContext context) {
  return Scaffold(
    ...
    body: latitudActual == null || longitudActual == null
        ...
        : FutureBuilder<List<Usuario>>(
            future: _firestoreService.obtenerUsuariosCercanos(latitudActual!, longitudActual!),
            builder: (context, snapshot) {
              ...
              if (!snapshot.hasData || snapshot.data!.isEmpty) {
                return const Center(child: Text('No hay usuarios cercanos', style: headerTextStyle,));
              }
              ...
              final filteredUsuarios = usuarios.where((usuario) => usuario.id != currentUser!.uid).toList();

              // Ordenar los usuarios por distancia
              filteredUsuarios.sort((a, b) {
                double distanciaA = _firestoreService.calcularDistancia(latitudActual!, longitudActual!, a.latitud!, a.longitud!);
                double distanciaB = _firestoreService.calcularDistancia(latitudActual!, longitudActual!, b.latitud!, b.longitud!);
  ...
  if (chatExistente == null) {
    ...
    ChatModel nuevoChat = ChatModel(
      ...
      usuarioId: usuario.id, // ID del usuario con el que se está creando el chat
      username: usuario.name,
      lastMessage: '', // Iniciar con un mensaje vacío
      distance: _firestoreService.calcularDistancia(latitudActual!, longitudActual!, usuario.latitud!, usuario.longitud!),
